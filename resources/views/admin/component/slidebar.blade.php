<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item open @active('riwayat')">
        ...
        <li class="menu-item ">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Data Pemohon</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item ">
                    <a href="#" class="menu-link">
                        <div data-i18n="Account">RT 1</div>
                    </a>
                </li>
                <li class="menu-item ">
                    <a href="#" class="menu-link">
                        <div data-i18n="Notifications">RT 2</div>
                    </a>
                </li>
            </ul>
        </li>
