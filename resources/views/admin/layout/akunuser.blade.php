...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card akun_user">
        <a>
            <button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#tambahuser">Tambah Akun</button>
        </a>
        <div class="text-nowred table-responsive pt-0">
                ...
                @foreach ($data as $d)
                        <tr>
                            ...
                            <td class="button-table">
                                <button type="button"  data-bs-toggle="modal" data-bs-target="#edituser{{$d -> id}}" class="btn btn-warning">Edit</button>
                        ...
                        <div class="modal fade" id="edituser{{$d -> id}}" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none;" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                ...
                                <form action="/admin/akunuser/update/{{$d -> id}}" method="POST">
                                    @csrf
                                    @method('PUT')
          ...
          {{-- modal tambah --}}
          <div class="modal fade" id="tambahuser" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
