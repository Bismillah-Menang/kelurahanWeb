...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card pemohon">
                                ...
                                <form action="/user/pemohon/edit/{{ $item->id }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <select id="agama{{ $item->id }}" class="form-select" name="agama">
                                            ...
                                            <option value="Konghuchu" {{ $item->agama == 'Konghuchu' ? 'selected' : '' }}>Konghuchu
                                            </option>
                                        </select>
        ...
        <div class="modal fade" id="aiman" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="/user/pemohon/tambah" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <select id="pilih_rt" class="form-select" name="pilih_rt">
                                @php
                                // Buat array untuk menyimpan opsi RT dengan format yang diinginkan
                                ...
                                {{-- Periksa apakah opsi yang dipilih saat ini cocok dengan opsi saat ini --}}
                                @php
                                $selected = ($option == old('pilih_rt')) ? 'selected' : '';
                                @endphp
...
<div class="modal fade" id="tambahpemohon" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <label for="nik" class="form-label">NIK</label>
                <input type="text" class="form-control mb-2" name="nik" id="nika" placeholder="Masukkan NIK" aria-describedby="defaultFormControlHelp" />
