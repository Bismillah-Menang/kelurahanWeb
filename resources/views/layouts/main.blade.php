...
<div class="wrapper">
  ...
  {{-- <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="img/logolengkapbadean.png" alt="AdminLTELogo" height="60" width="60">
  </div> --}}
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="img/logobadean.png" alt="E - Badean" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">E-Badean</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Admin Badean</a>
        </div>
      </div>
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{route ('petugas')}}" class="nav-link">
                      <i class="fi fi-rr-user-pilot-tie"></i>
                      <p>Petugas</p>
                    </a>
                  </li>
                  <li class="nav-item">
